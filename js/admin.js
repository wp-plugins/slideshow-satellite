...
SWFUpload.onload = function () {
    var settings_object = { 
            upload_url : "../wp-admin/admin.php?page=satellite-newgallery&method=upload",
            upload_url : "../wp-content/plugins/slideshow-satellite/etc/upload.php",
            flash_url : "../wp-content/plugins/slideshow-satellite/etc/swfupload.swf", 
