<table class="form-table">
    <tbody>
        ...
        <tr>
            <th><label for="satshort"><?php _e('Shortcode Requirement', SATL_PLUGIN_NAME); ?></label></th>
            <td>
                <select name="satshort" class="satellite_trans">
                    <option <?php echo ($this->get_option('satshort') == "Y") ? 'selected' : ''; ?> value="Y"><?php _e('On', SATL_PLUGIN_NAME); ?></option> 
                    <option <?php echo ($this->get_option('satshort') == "N") ? 'selected' : ''; ?> value="N"><?php _e('Off', SATL_PLUGIN_NAME); ?></option> 
                </select>
            	<span class="howto"><?php _e('Only display CSS and JS when shortcode ie.,[satellite] appears in "The Wordpress Loop".', SATL_PLUGIN_NAME); ?></span>
            </td>
        </tr>
        <tr>
